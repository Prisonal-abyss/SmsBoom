...
def main(phone):
    ...
    while i > 0:
        ...
        print(f"{time.strftime('%Y-%m-%d %H:%M:%S', time.localtime())} Round{i}attack is complete!After 60 seconds,start round{i + 1}attack!")
        time.sleep(60)
        i += 1

if __name__ == '__main__':
    # 手机号
    phone = input("Please enter the attacked telephone num:")
